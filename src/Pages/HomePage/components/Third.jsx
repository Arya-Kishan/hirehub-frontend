    ...
    return (
        <div className='w-full h-[40vh] md:h-[70vh] flex justify-center items-center relative overflow-hidden bg-gradient-to-r from-teal-500 to-teal-800'>
            ...
            <div className='w-[80%] md:w-[50%] h-[150px] md:h-[300px] flex flex-col justify-evenly items-center bg-white shadow-inner shadow-black rounded-2xl relative z-[10]'>
                <img loading='lazy' className='w-[50px] md:w-[100px] absolute top-[0%] left-[50%] -translate-x-[50%] -translate-y-[50%]' src={person3} alt="" />
                <p></p>
                ...
                <img loading='lazy' className='w-[35px] md:w-[80px] absolute top-[80%] left-[95%]' src={happy} alt="" />
            </div>

            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[60%] -left-[30px]' src={person1} alt="" />
            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[20%] left-[10%]' src={person2} alt="" />
            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[80%] left-[12%]' src={person3} alt="" />

            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[40%] right-[10%]' src={person4} alt="" />
            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[15%] right-[20%]' src={person5} alt="" />
            <img loading='lazy' className='z-[5] w-[35px] md:w-[80px] absolute top-[10%] -right-[30px]' src={person6} alt="" />
