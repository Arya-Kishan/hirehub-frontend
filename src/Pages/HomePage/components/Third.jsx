...
const Third = () => {
    return (
        <div className='w-full h-[40vh] md:h-[70vh] flex justify-center items-center relative overflow-hidden bg-gradient-to-r from-teal-500 to-teal-800'>
            ...
            <div className='w-[80%] md:w-[50%] h-[150px] md:h-[300px] flex flex-col justify-evenly items-center bg-teal-500 rounded-2xl relative z-[10]'>
                ...
                <button className='text-[14px] md:text-xl bg-teal-800 px-5 py-2 rounded-xl'>Explore</button>
