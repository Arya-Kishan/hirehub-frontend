...
import { fetchMyPostAsync, getNotificationsAsync, selectMyPosts, sendFriendRequestAsync, setDialog } from '../../Community/communitySlice'
import { deleteAccountAsync, getOtherUserDetailAsync, selectLoggedInUser, selectOtherUserDetail, selectUserId } from '../../User/userSlice'
...
const Profile = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    dispatch(setDialog({ show: true, type: "user", id: loggedInUserId }));
